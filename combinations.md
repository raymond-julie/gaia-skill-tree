...
| ◇ Prompt Optimization | Extra Skill | Evaluate Output, Generate Text | IV · Hardened |  |
...
| ◇ Registry Curation | Extra Skill | Research, Code Generation, Execute Bash | IV · Hardened | Requires write access to the canonical graph and a passing validation suite. |
...
| ◇ Tool Creation | Extra Skill | Code Generation, Tool Use | IV · Hardened |  |
