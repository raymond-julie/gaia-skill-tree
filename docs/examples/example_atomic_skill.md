# Example: New Atomic Skill Submission

This is a filled-out example of a `new_atomic_skill.md` PR for reference.
...
- [x] `prerequisites` array is empty (atomic skills have no parents).
