# Example: New Composite Skill Submission

This is a filled-out example of a `new_composite_skill.md` PR for reference.
...
- [x] Evidence meets the minimum threshold (Level III = Class B+).
