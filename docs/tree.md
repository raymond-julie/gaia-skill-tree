...
```
══════════════════════════════════════════════════════════════════════
GAIA SKILL TREE  ·  generated 2026-07-17
══════════════════════════════════════════════════════════════════════
◇ Fusion · ○ Basic   ·   [N★] = top named-variant stars (blank = no named implementation yet) · (↑ see above) = shared prerequisite
...
*Generated from gaia.json on 2026-07-17. Do not edit directly.*
