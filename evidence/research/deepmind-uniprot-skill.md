[Skip to content](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md) to refresh your session.Dismiss alert
...
[History](https://github.com/google-deepmind/science-skills/commits/main/skills/uniprot_database/SKILL.md)

Open commit details

[View commit history for this file.](https://github.com/google-deepmind/science-skills/commits/main/skills/uniprot_database/SKILL.md) History

292 lines (237 loc) · 12 KB
...
[Raw](https://github.com/google-deepmind/science-skills/raw/refs/heads/main/skills/uniprot_database/SKILL.md)
...
[Permalink: UniProt Database Access](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#uniprot-database-access)

## Prerequisites

[Permalink: Prerequisites](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#prerequisites)

1. **`uv`**: Read the `uv` skill and follow its Setup instructions to ensure
`uv` is installed and on PATH.
2. **User Notification**: If LICENSE\_NOTIFICATION.txt does not already exist in
this skill directory then (1) prominently notify the user to check the terms
at [https://www.uniprot.org/help/license](https://www.uniprot.org/help/license) and
[https://www.uniprot.org/help/api\_queries](https://www.uniprot.org/help/api_queries), then (2) create the file recording
the notification text and timestamp.

## Overview

[Permalink: Overview](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#overview)
...
[Permalink: Core Rules](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#core-rules)
...
[Permalink: Use Cases](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#use-cases)
...
[Permalink: Available Tools](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#available-tools)
...
**and discovery**.
  ...
  - Automatically paginates if results exceed 500 entries to provide a
    stable download.
  - _Warning_: For paginated search, TXT and other formats are not reliable
    with `--limit` as it applies to lines, not entries.
  - See
    [Search Query Fields Documentation](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/references/search_query_fields.md).
...
counting, exact sequence matches, and multi-database queries.
  ...
  - See [SPARQL Examples](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/references/sparql_examples.md).
- **`map`**: Converts IDs between UniProt and 100+ databases. Best for ID
mapping tasks.

  - See [ID Mapping Documentation](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/references/id_mapping_documentation.md).
...
[Permalink: Workflows](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#workflows)

### Typical Protein Research Workflow

[Permalink: Typical Protein Research Workflow](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#typical-protein-research-workflow)
...
[Permalink: Handling Search Misses (e.g. Gene Search in Non-Model Organisms)](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#handling-search-misses-eg-gene-search-in-non-model-organisms)
...
[Permalink: Bulk Retrieval Priorities](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#bulk-retrieval-priorities)
...
[Permalink: Sequence-Based Search (Exact Match)](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#sequence-based-search-exact-match)
...
[Permalink: Counting Entries Efficiently](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#counting-entries-efficiently)
...
[Permalink: REST Search Syntax](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#rest-search-syntax)
...
[Permalink: Example Commands](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#example-commands)
...
[Permalink: Common Mistakes](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#common-mistakes)
...
- **Ignoring Citation Noise in Broad Searches**: Broad text searches (`search "term"`) frequently return false positives (e.g., common maintenance
...
`lanM`) can match substrings in organism names (e.g., _Lan_ cefieldella) or
...
[Permalink: Reference Materials](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/SKILL.md#reference-materials)

- [SPARQL Examples](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/references/sparql_examples.md)
- [Search Query Fields Documentation](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/references/search_query_fields.md)
- [ID Mapping Documentation](https://github.com/google-deepmind/science-skills/blob/main/skills/uniprot_database/references/id_mapping_documentation.md)
