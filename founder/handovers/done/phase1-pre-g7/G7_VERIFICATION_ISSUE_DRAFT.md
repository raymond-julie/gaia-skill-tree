...
| **G5** [#708](../pull/708) `design/share-page` | Static share-bundle renderer at `gaiaskilltree.com/share/` | No direct G7 dep. But share bundles include skill metadata and snapshots; I6 display layer should ensure shared bundles surface the new TM badge so consumers see the same number a sharer sees. |
