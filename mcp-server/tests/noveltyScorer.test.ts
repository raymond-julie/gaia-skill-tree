...
const mockGraph: GaiaGraph = {
  ...
  skills: [
    { id: "web-search", name: "Web Search", type: "atomic", level: "II", rarity: "common", description: "Searches the web for information using search engine APIs", prerequisites: [], derivatives: [], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "summarize", name: "Summarize", type: "atomic", level: "II", rarity: "common", description: "Condenses long text into concise summaries preserving key information", prerequisites: [], derivatives: [], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
  ],
  edges: [],
};
