...
const mockGraph: GaiaGraph = {
  ...
  skills: [
    { id: "web-search", name: "Web Search", type: "atomic", level: "II", rarity: "common", description: "Searches the web", prerequisites: [], derivatives: ["web-scrape", "research"], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "parse-html", name: "Parse HTML", type: "atomic", level: "II", rarity: "common", description: "Parses HTML documents", prerequisites: [], derivatives: ["web-scrape"], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "extract-entities", name: "Extract Entities", type: "atomic", level: "II", rarity: "common", description: "Extracts named entities", prerequisites: [], derivatives: ["web-scrape"], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "summarize", name: "Summarize", type: "atomic", level: "II", rarity: "common", description: "Summarizes text", prerequisites: [], derivatives: ["research"], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "cite-sources", name: "Cite Sources", type: "atomic", level: "II", rarity: "common", description: "Cites sources", prerequisites: [], derivatives: ["research"], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "web-scrape", name: "Web Scrape", type: "composite", level: "III", rarity: "uncommon", description: "Scrapes and structures web data", prerequisites: ["web-search", "parse-html", "extract-entities"], derivatives: [], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
    { id: "research", name: "Research", type: "composite", level: "III", rarity: "uncommon", description: "Researches topics", prerequisites: ["web-search", "summarize", "cite-sources"], derivatives: [], conditions: "", evidence: [], knownAgents: [], status: "validated", createdAt: "", updatedAt: "", version: "0.1.0" },
  ],
  edges: [],
};
