...
| ◇ [ruvnet](../docs/u/ruvnet/)/sparc-methodology | Extra Skill | Workflow Automation, Plan and Decompose | 3★ | Requires a workflow orchestration target (e.g. Airflow, Temporal) and access to its authoring API. |
