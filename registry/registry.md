...
| ◇ [garrytan](../docs/u/garrytan/)/health | Extra Skill | 2★ | `/automated-testing` |
...
| ○ /classify | Basic Skill | — | `/classify` |
| ○ [ruvnet](../docs/u/ruvnet/)/v3-cli-modernization | Basic Skill | 2★ | `/cli-modernization` |
| ◇ [ruvnet](../docs/u/ruvnet/)/flow-nexus-platform | Extra Skill | 2★ | `/cloud-platform-management` |
...
| ◇ ████████/huggingface-datasets | Extra Skill | — | `/data-analysis` |
| ○ /data-visualize | Basic Skill | — | `/data-visualize` |
| ◇ [garrytan](../docs/u/garrytan/)/land-and-deploy | Extra Skill | 3★ | `/deployment-automation` |
| ◇ [nexu-io](../docs/u/nexu-io/)/open-design | Extra Skill | 2★ | `/design-generation` |
| ◇ [garrytan](../docs/u/garrytan/)/design-shotgun | Extra Skill | 3★ | `/design-review` |
| ◇ [garrytan](../docs/u/garrytan/)/design-consultation | Extra Skill | 3★ | `/design-system-extraction` |
| ◇ [garrytan](../docs/u/garrytan/)/canary | Extra Skill | 3★ | `/detect-anomaly` |
| ○ /diff-content | Basic Skill | — | `/diff-content` |
| ◇ [obra](../docs/u/obra/)/dispatching-parallel-agents | Extra Skill | 3★ | `/dispatching-parallel-agents` |
| ◇ [ruvnet](../docs/u/ruvnet/)/hive-mind-coordination | Extra Skill | 3★ | `/distributed-consensus-coordination` |
| ◇ [ruvnet](../docs/u/ruvnet/)/flow-nexus-neural | Extra Skill | 2★ | `/distributed-neural-training` |
| ◇ [ruvnet](../docs/u/ruvnet/)/agentdb-advanced | Extra Skill | 2★ | `/distributed-vector-memory` |
| ◇ /document-analyst | Extra Skill | — | `/document-analyst` |
| ○ [garrytan](../docs/u/garrytan/)/document-generate | Basic Skill | 3★ | `/document-editing` |
| ◇ [ruvnet](../docs/u/ruvnet/)/dual-mode | Extra Skill | 4★ | `/dual-mode` |
...
| ○ [nousresearch](../docs/u/nousresearch/)/feed-monitoring | Basic Skill | 2★ | `/feed-monitoring` |
...
| ○ [upsonic](../docs/u/upsonic/)/unittest-generator | Basic Skill | 2★ | `/generate-test` |
| ○ /generate-text | Basic Skill | — | `/generate-text` |
...
| ◇ [favorchurch](../docs/u/favorchurch/)/speak-like-favor | Extra Skill | 2★ | `/humanize-prose` |
...
| ○ [mattpocock](../docs/u/mattpocock/)/triage | Basic Skill | 3★ | `/issue-triage` |
| ◇ [safishamsi](../docs/u/safishamsi/)/graphify | Extra Skill | 4★ | `/knowledge-graph-build` |
...
| ○ [garrytan](../docs/u/garrytan/)/pair-agent | Basic Skill | 2★ | `/mcp-integration` |
| ◇ /mcp-server-creation | Extra Skill | — | `/mcp-server-creation` |
| ◇ [garrytan](../docs/u/garrytan/)/learn | Extra Skill | 2★ | `/memory-manage` |
| ○ [ruvnet](../docs/u/ruvnet/)/agentdb-memory-patterns | Basic Skill | 2★ | `/memory-pattern-design` |
...
| ◇ [mattpocock](../docs/u/mattpocock/)/to-prd | Extra Skill | 3★ | `/prd-generation` |
...
| ◇ [stanfordnlp](../docs/u/stanfordnlp/)/dspy | Extra Skill | 4★ | `/prompt-optimization` |
...
| ◇ [mattpocock](../docs/u/mattpocock/)/prototype | Extra Skill | 2★ | `/prototype` |
| ○ [garrytan](../docs/u/garrytan/)/office-hours | Basic Skill | 3★ | `/question-answer` |
| ◇ ████████/orchestkit-rag | Extra Skill | — | `/rag-pipeline` |
| ○ /rank | Basic Skill | — | `/rank` |
| ◇ /re-act-reasoning | Extra Skill | — | `/re-act-reasoning` |
| ◇ /real-time-voice-assistant | Extra Skill | — | `/real-time-voice-assistant` |
...
| ◇ ████████/release | Extra Skill | — | `/release-automation` |
| ◇ [obra](../docs/u/obra/)/requesting-code-review | Extra Skill | 2★ | `/requesting-code-review` |
| ○ ████████/requirements-engineer | Basic Skill | — | `/requirements-analysis` |
...
| ◇ [garrytan](../docs/u/garrytan/)/cso | Extra Skill | 3★ | `/security-audit` |
...
| ◇ [gaia-research](../docs/u/gaia-research/)/skill-fuse | Extra Skill | 2★ | `/skill-fusion` |
...
| ○ /statistical-analysis | Basic Skill | — | `/statistical-analysis` |
| ◇ /stealth-browser-interaction | Extra Skill | — | `/stealth-browser-interaction` |
| ○ /structured-output | Basic Skill | — | `/structured-output` |
...
| ○ [ruvnet](../docs/u/ruvnet/)/swarm-orchestration | Basic Skill | 2★ | `/swarm-topology-management` |
| ○ [ruvnet](../docs/u/ruvnet/)/v3-integration-deep | Basic Skill | 2★ | `/system-integration` |
| ◇ [garrytan](../docs/u/garrytan/)/investigate | Extra Skill | 3★ | `/systematic-debugging` |
...
| ◇ /translation-pipeline | Extra Skill | — | `/translation-pipeline` |
| ◇ /tree-of-thought | Extra Skill | — | `/tree-of-thought` |
| ◇ [mattpocock](../docs/u/mattpocock/)/ubiquitous-language | Extra Skill | 3★ | `/ubiquitous-language` |
| ◇ [obra](../docs/u/obra/)/using-git-worktrees | Extra Skill | 4★ | `/using-git-worktrees` |
...
| ◇ [obra](../docs/u/obra/)/verification-before-completion | Extra Skill | 3★ | `/verification-before-completion` |
...
| ◇ [obra](../docs/u/obra/)/writing-plans | Extra Skill | 4★ | `/writing-plans` |
...
| ○ CRM Data Cleanup | Intrinsic Skill | 2★ | `/crm-data-cleanup` |
| ○ Cultural Localization | Intrinsic Skill | — | `/cultural-localization` |
| ○ Domain Modeling | Intrinsic Skill | — | `/domain-modeling` |
| ○ Event Attendance Metrics | Intrinsic Skill | 2★ | `/event-attendance-metrics` |
| ○ Event Attendee Management | Intrinsic Skill | 2★ | `/event-attendee-management` |
| ○ Event Support Triage | Intrinsic Skill | 2★ | `/event-support-triage` |
| ○ Event Ticket Transfer | Intrinsic Skill | 2★ | `/event-ticket-transfer` |
...
| ○ Grant Application Processing | Intrinsic Skill | 2★ | `/grant-application-processing` |
...
| ○ Transactional Email Resend | Intrinsic Skill | 2★ | `/transactional-email-resend` |
