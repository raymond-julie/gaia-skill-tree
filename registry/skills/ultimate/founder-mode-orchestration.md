# [garrytan](../../../docs/u/garrytan/)/gstack  [5★]
**ID:** founder-mode-orchestration  
**Type:** Ultimate Skill  
**Rank:** _rank-less generic reference — stars are earned by named implementations_  
**Top named variant:** 5★  
**Skill Call:** `/founder-mode-orchestration`
...
- [Browser Control](../basic/browser-control.md)
...
- [Knowledge Management](../extra/knowledge-management.md)
- [Format Output](../basic/format-output.md)
- [Workspace Automation](../extra/workspace-automation.md)
...
## Fusion Condition
Requires demonstrating all 31 garrytan discipline skills together in a real multi-step context.
