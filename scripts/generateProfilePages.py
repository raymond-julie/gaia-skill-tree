...
NAV_HTML = f"""<nav>
  ...
  <button type="button" class="nav-search-btn-mobile" id="navSearchBtnMobile" aria-label="Search named"><svg class="ico" width="18" height="18" aria-hidden="true"><use href="{ICON_SPRITE_REL}#search"/></svg></button>
...
def build_directory_page(by_contributor: dict) -> str:
  ...
  <button type="button" class="nav-search-btn-mobile" id="navSearchBtnMobile" aria-label="Search named"><svg class="ico" width="18" height="18" aria-hidden="true"><use href="../assets/icons.svg#search"/></svg></button>
  <button class="nav-menu-toggle" type="button" aria-label="Open navigation" aria-expanded="false">
    <span></span>
    <span></span>
    <span></span>
