#!/usr/bin/env python3
"""Render graph/gaia.svg from the canonical Gaia skill graph."""
...
from plugin.cli.graph import write_graph_artifact  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("-o", "--output", default=None, help="Output path (default: graph/gaia.svg)")
